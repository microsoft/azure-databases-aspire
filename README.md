...
| `.WithDataBindMount(source, isReadOnly?)` | Persist data with a host directory mount (does not survive a restart on Docker Desktop — see [troubleshooting](docs/troubleshooting.md#bind-mounted-data-fails-to-restart-on-docker-desktop)) |
