...
- `WithDataVolume(targetPath: ...)` now validates the target path. Empty, whitespace, relative, and container-root paths are rejected with an `ArgumentException`, and a trailing slash is normalized.
